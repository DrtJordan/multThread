...
/**
 * 
 * Description: 场景:当别人访问时获取想要的数据，并且后端处理可能是比较耗时操作并且获取数据之后要进行后续处理时一般我们的设计是采用接口回调的方式
 * Created on:  2016年12月14日 下午4:48:07 
 * @author bbaiggey
 ...
 */
	...
	public void doWork() {
		...
		fetcher.fetchData(new FetcherCallback() {
			...
			public void onData(Data data) {
				System.out.println("正常回调,最终拿到task的执行结果: " + data.toString());
			}
		});
	}
	...
	public static void main(String[] args) {
		Worker w = new Worker();
		w.doWork();//作业很耗时 提交之后主线程继续干活
		System.out.println("---------");
		System.out.println("继续其他的作业执行....");
	}
